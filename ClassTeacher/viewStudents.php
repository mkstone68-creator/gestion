...
$query = "SELECT c.className, ca.classArmName 
    FROM tblclass c
    LEFT JOIN tblclassarms ca ON ca.Id = '$classArmId'
    WHERE c.Id = '$classId'";
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      ...
                      tblstudents.lastName,tblstudents.formationName,tblstudents.admissionNumber,tblstudents.dateCreated
                      FROM tblstudents
